"""
Local CodeAgent that overrides only _step_stream() from smolagents.
All other methods are inherited from the smolagents source code.
"""
import json
...
from smolagents.agents import (
    ActionOutput,
    CodeAgent as _SmolagentsCodeAgent,
    MultiStepAgent,
    ToolCallingAgent,
    ToolOutput,
)
...
class CodeAgent(_SmolagentsCodeAgent):
    """CodeAgent with a custom _step_stream() override. All other methods
    are inherited from smolagents.CodeAgent."""

    def _step_stream(
        self, memory_step: ActionStep
    ) -> Generator[Union[ChatMessageStreamDelta, ToolCall, ToolOutput, ActionOutput], None, None]:
        """
