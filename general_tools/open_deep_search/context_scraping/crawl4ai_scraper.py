...
from general_tools.open_deep_search.context_scraping.extraction_result import ExtractionResult, print_extraction_result
from general_tools.open_deep_search.context_scraping.basic_web_scraper import ExtractionConfig
from general_tools.open_deep_search.context_scraping.strategy_factory import StrategyFactory
...
class WebScraper:
    ...
    async def scrape(self, url: str) -> Dict[str, ExtractionResult]:
        ...
        if 'wikipedia.org/wiki/' in url:
            from general_tools.open_deep_search.context_scraping.utils import get_wikipedia_content
            try:
            ...
            if result.success:
                if extraction_config.name in ['no_extraction', 'cosine']:
                    ...
                    if self.filter_content and content:
                        from general_tools.open_deep_search.context_scraping.utils import filter_quality_content
